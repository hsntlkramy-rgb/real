// Real Estate Properties Data - Each property has a UNIQUE image
...
// Generate 400+ real-looking UAE properties with UNIQUE images
export const generateUAEProperties = (): Property[] => {
  ...
  // Generate 400 properties with UNIQUE images
  for (let i = 0; i < 400; i++) {
